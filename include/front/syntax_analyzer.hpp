...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // PrimaryExp
      char dummy35[sizeof (AstPrimaryExp*)];

      // RelExp
      char dummy36[sizeof (AstRelExp*)];

      // ReturnStmt
      char dummy37[sizeof (AstReturnStmt*)];

      // SelectStmt
      char dummy38[sizeof (AstSelectStmt*)];

      // Stmt
      char dummy39[sizeof (AstStmt*)];

      // UnaryExp
      char dummy40[sizeof (AstUnaryExp*)];

      // VarDecl
      char dummy41[sizeof (AstVarDecl*)];

      // VarDef
      char dummy42[sizeof (AstVarDef*)];

      // VarDefList
      char dummy43[sizeof (AstVarDefList*)];

      // BType
      char dummy44[sizeof (BType)];

      // UnaryOp
      char dummy45[sizeof (UnaryOp)];

      // NUMBER
      char dummy46[sizeof (int)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_Begin = 45,                            // Begin
        S_CompUnit = 46,                         // CompUnit
        S_DeclDef = 47,                          // DeclDef
        S_ConstDecl = 48,                        // ConstDecl
        S_ConstDefList = 49,                     // ConstDefList
        S_ConstDef = 50,                         // ConstDef
        S_ArrayConstExpList = 51,                // ArrayConstExpList
        S_ConstInitVal = 52,                     // ConstInitVal
        S_ConstInitValList = 53,                 // ConstInitValList
        S_VarDecl = 54,                          // VarDecl
        S_VarDefList = 55,                       // VarDefList
        S_VarDef = 56,                           // VarDef
        S_InitVal = 57,                          // InitVal
        S_InitValList = 58,                      // InitValList
        S_FuncDef = 59,                          // FuncDef
        S_BType = 60,                            // BType
        S_FuncFParamList = 61,                   // FuncFParamList
        S_FuncFParam = 62,                       // FuncFParam
        S_ParamArrayExpList = 63,                // ParamArrayExpList
        S_Block = 64,                            // Block
        S_BlockItemList = 65,                    // BlockItemList
        S_BlockItem = 66,                        // BlockItem
        S_Stmt = 67,                             // Stmt
        S_BreakStmt = 68,                        // BreakStmt
        S_ContinueStmt = 69,                     // ContinueStmt
        S_AssignStmt = 70,                       // AssignStmt
        S_SelectStmt = 71,                       // SelectStmt
        S_IterationStmt = 72,                    // IterationStmt
        S_ReturnStmt = 73,                       // ReturnStmt
        S_Exp = 74,                              // Exp
        S_Cond = 75,                             // Cond
        S_LVal = 76,                             // LVal
        S_ArrayExpList = 77,                     // ArrayExpList
        S_PrimaryExp = 78,                       // PrimaryExp
        S_Number = 79,                           // Number
        S_UnaryExp = 80,                         // UnaryExp
        S_Callee = 81,                           // Callee
        S_UnaryOp = 82,                          // UnaryOp
        S_ExpList = 83,                          // ExpList
        S_MulExp = 84,                           // MulExp
        S_AddExp = 85,                           // AddExp
        S_RelExp = 86,                           // RelExp
        S_EqExp = 87,                            // EqExp
        S_LAndExp = 88,                          // LAndExp
        S_LOrExp = 89,                           // LOrExp
        S_ConstExp = 90                          // ConstExp
      };
    };
...
#line 3597 "/my/cminus-compiler/include/front/syntax_analyzer.hpp"
